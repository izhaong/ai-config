...
function skipBrowseCurrentToggle(
  ...
  if (
    ctx.browsingSource &&
    ctx.activePlatform === "agentsmanager" &&
    plat === "agentsmanager"
  ) {
    return true;
  }
...
export function resolveBatchPlatformToggleMode(
  ...
  if (browsingSource && activePlatform === "agentsmanager" && plat === "agentsmanager") {
    return "activate_all";
  }
...
export function resolveEntryPlatformToggleAction(
  ...
  if (plat === "agentsmanager") {
    const state = entry.states.agentsmanager;
