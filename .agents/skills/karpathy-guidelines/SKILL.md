...
description: 编码前思考、简单优先、手术式修改、可验证完成。与 .agents-manager/rules/karpathy-guidelines.mdc 同源。
---

# Karpathy Guidelines

实现 agents-manager 代码时遵守以下四条（详见 `.agents-manager/rules/karpathy-guidelines.mdc`）：
