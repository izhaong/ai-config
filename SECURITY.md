...
1. [GitHub Private Security Advisories](https://github.com/izhaong/ai-config/security/advisories/new) for this repository, **or**
...
- Store credentials only in `~/.config/ai-config/secrets.env` (local, mode `0600`).
