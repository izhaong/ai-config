...
1. [GitHub Private Security Advisories](https://github.com/izhaong/agent-manager/security/advisories/new) for this repository, **or**
...
- Store credentials only in `~/.config/agent-manager/secrets.env` (local, mode `0600`).
