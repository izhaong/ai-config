...
2. `.agents-manager/rules/00-agents-manager-core.mdc`
...
Commands 与 Skills 位于 `.agents-manager/commands/`、`.agents-manager/skills/`；Claude 的运行时目录由 source-first projection 本地生成，不再追踪副本。
