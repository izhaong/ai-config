...
| [vercel-skills-agent-paths.md](./reference/vercel-skills-agent-paths.md)             | 第三方 CLI 历史快照，只作 legacy inventory，不能决定 agents-manager 投影路径                                   |
...
| `.cursor/agents/`                     | `rust-agents-manager-dev`、`gui-agents-manager-dev`            |
| `.cursor/skills/`                     | 交付、验证、行为准则                                 |
| `.cursor/COMMANDS.md`                 | `/speckit.*`、`/agents-manager-verify` 等                 |
