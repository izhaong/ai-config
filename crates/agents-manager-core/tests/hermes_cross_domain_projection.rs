...
use agents_manager_core::projection::model::{DeploymentScope, EffectiveAsset, SourceLayer, SourceRef};
...
impl ProjectionLedger for FailingApplyLedger<'_> {
    fn get(
        &self,
        id: &agents_manager_core::projection::model::ProjectionId,
    ) -> Result<Option<agents_manager_core::projection::model::ProjectionRecord>, CoreError> {
        self.inner.get(id)
    }
    ...
    fn get_many(
        &self,
        ids: &[agents_manager_core::projection::model::ProjectionId],
    ) -> Result<Vec<agents_manager_core::projection::model::ProjectionRecord>, CoreError> {
