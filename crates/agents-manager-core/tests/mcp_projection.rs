...
use agents_manager_core::model::PlatformId;
use agents_manager_core::projection::executor::{
...
use agents_manager_core::projection::mcp::claude_json::{
    render_claude_mcp_json, ClaudeJsonServerIntent,
};
use agents_manager_core::projection::mcp::codex_toml::{render_codex_mcp_toml, TomlServerIntent};
use agents_manager_core::projection::mcp::cursor_json::{render_cursor_mcp_json, JsonServerIntent};
use agents_manager_core::projection::mcp::entry_fingerprint::{
    inspect_claude_mcp_entries, inspect_codex_mcp_entries, inspect_cursor_mcp_entries,
    inspect_hermes_mcp_entries,
};
use agents_manager_core::projection::mcp::hermes_yaml::{render_hermes_mcp_yaml, YamlServerIntent};
use agents_manager_core::projection::mcp::source::{
...
use agents_manager_core::projection::source::OverlayRoots;
use camino::Utf8Path;
...
"#,
    ...
    let adoption = agents_manager_core::projection::planner::ProjectionPlan {
    ...
    ledger
        .apply_batch(&[LedgerMutation::Upsert(ProjectionRecord {
            id: ProjectionId {
                ...
                kind: agents_manager_core::model::AssetKind::Mcp,
