//! `agents-manager secrets ...` 子命令(PRD §5.1 必做 + §10 A-5 / A-12 / A-14)。
//!
//! 关键约束:
...
//! - 所有写盘路径走 `agents_manager_core::secrets::save_to`(强制 0600 + 原子)
...
use agents_manager_core::secrets as core_secrets;
