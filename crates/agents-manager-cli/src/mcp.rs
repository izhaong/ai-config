...
use agents_manager_core::model::{McpServer, PlatformId};
...
use agents_manager_core::projection::model::DeploymentScope;
...
struct McpProjectionCommandReport<'a> {
    ...
    server: &'a str,
    platform: &'a str,
    report: agents_manager_core::projection::executor::ApplyReport,
}
